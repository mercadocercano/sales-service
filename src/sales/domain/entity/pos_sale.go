...
// customer_id = uuid.Nil → venta anónima (Consumidor Final)
type PosSale struct {
...
// customer_id = uuid.Nil → venta anónima (Consumidor Final), permitido
func NewPosSale(
	tenantID uuid.UUID,
	customerID uuid.UUID, // uuid.Nil = Consumidor Final
